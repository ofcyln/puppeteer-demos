...
exports.morningHailOnWeekdays1 = scheduleFnAt('19 8 * * 1');
exports.morningHailOnWeekdays2 = scheduleFnAt('07 8 * * 2');
exports.morningHailOnWeekdays3 = scheduleFnAt('25 8 * * 3');
exports.morningHailOnWeekdays4 = scheduleFnAt('03 8 * * 4');
exports.morningHailOnWeekdays5 = scheduleFnAt('09 8 * * 5');
exports.morningHailOnWeekends1 = scheduleFnAt('44 10 * * 6');
exports.morningHailOnWeekends2 = scheduleFnAt('29 11 * * 0');
